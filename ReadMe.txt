...
2. скопіювати на micro sd-flash пристрою в папку /fm (якщо нема - створити)
3. повернути флеш до пристрою та перезавантажити його
4. почекати 1-2 хвилини поки пристрій не вимкнеться сам
5. перезавантажити, знов придєднатися та перевірити версію нового ПЗ на головній сторінці (то з чим перевіряти низче)
