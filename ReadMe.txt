...
5. перезавантажити знов пидєднатися та перевірити версію нового ПЗ на головній сторінці

de855fa (May 30 2024 22:33:57) 5b21a4d92a523e03
 - log clenup for previous build
...
- додаткові умови реініціалізації GSM при не доброму рівні сигнало
